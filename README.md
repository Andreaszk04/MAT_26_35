...
**3. Local Material sourcing:** Transportation and import of building materials is often contribute significantly to a higher GWP. By linking origin and transport data to a materialin the BIM, project teams can identify locally sourced local alternatives and thereby reduce the transport related emmissions. 
