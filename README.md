...
**3. Local Material sourcing:** Transportation and import of building materials often contributes significantly to a higher GWP. By linking origin and transport data to a material in the BIM, project teams can identify locally sourced alternatives and thereby reduce the transport related emmissions.<br>
**4. Utilizing remaining lifespan:** Not all materials utilize their entire life expectancy. Some material lifetimes are able to be prolonged with the right measures. Implementing a lifetime expectancy and possible measures to prolong lifetime expectancy could be a measure to make sure the materials full life expectancy is uttilized.<br>
**5. LCC + LCA Comparison:** Most LCA based decisions in the danish construction industry focuses primarily on the GWP. However, in practice most building owners makes decisions based on a combination of enviromental impact, economics and social sustainablity. By integrating Life Cycle Costing (LCC), for example, alongside LCA data in the material bank, project teams can compare material scenarios across both dimensions simultaneously. For example, a material with a higher upfront cost but lower emissions and longer service life, versus a cheaper material with more frequent replacement and higher overall environmental impact over the lifetime.
...
Group 1 (Section 1.2, page 3; Section 6, page 17-19)<br>
Group 2 (Section 6, page 29)<br>
Group 3 (Section 3, page 9-13)<br>
Group 4 (DGNB Section, page 9)<br>
Group 6 (Section 6.1, page 21)<br>
Group 8 (Section 5.4, page 40)<br>
Group 9 (Section 7.3, 7.4 and 7.6, pages 35-38)<br>
